...
const EditPost = (props) => {
    ...
    const [stateLocal, setState] = useState({title: props.location.state.post.title,
                                            body: props.location.state.post.body})

    const handleTitleChange = (event) => {
        setState({...stateLocal,totle: event.target.value})
    }
    ...
    const handleSubmit = (event) => {
        ...
        const pid = props.location.state.post.pid
